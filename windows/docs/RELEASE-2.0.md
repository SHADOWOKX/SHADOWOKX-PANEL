...
- Weather has a deadline covering response headers and the entire body, and reuses the resolved city coordinates. A stalled body cannot leave refresh running indefinitely.
...
- Secondary-instance activation has a deadline instead of waiting indefinitely for an unresponsive primary instance.
...
75 core tests cover cached/uncached pricing, unknown models, fork deduplication, persistent cache reuse, incremental reading of a 3 MB fixture, 50 fresh popup opens without extra Codex requests, bounded protocol output, cancellation, adaptive scheduling, and multi-monitor placement at 100–300% scaling.
